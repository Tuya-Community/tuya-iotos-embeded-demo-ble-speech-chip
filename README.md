...
This demo is based on the Tuya Smart Cloud Platform, Tuya Smart App, IoTOS Embeded Ble SDK, using Tuya BLE series modules to quickly build an offline voice demo with the ability to play offline voice.
...
| tuya_voice_prompt.c | voice-related code |
| tuya_voice_prompt.h | header file |
